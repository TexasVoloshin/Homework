...
public class Program4 {
	...
	public static void babelek(int[] tablica, int rozmiar) {
		...
		/*zad 2
		 * Pierwsza optymalizacja. Wewnêtrzna pêtla zmniejsza siê o 1, poniewa¿
		 * za ka¿dym jej przebiegiem najwiêkszy element jest na swojej pozycji.
		 * Nie trzeba z nim zatem porównywaæ innych liczb.
		 * 
		...
		/*
		* Trzecia optymalizacja. Podobnie jak w drugiej optymalizacji zewnêtrzna
		* pêtla zatrzymuje siê gdy w pêtli wewnêtrznej nie dokonano ani jednej
		* zamiany. Dodatkowo pêtla wewnêtrzna nie sprawdza ostatnich posortowanych
		* elementów nawet jeœli jest ich wiêcej ni¿ wynika³oby to z obiegów pêtli
		* zewnêtrznej.
		*/
		//Arrays.sort(iArr);
